...
const explorersInNode = explorers.filter((explorer) => explorer.mission == "node");//Se cuentan los exploradores en el archivo JSON
//console.log(explorersInNode.length)

// Part4: Get the explorer's usernames in Node
const explorersInNodeToGetUsernames = explorers.filter((explorer) => explorer.mission == "node");//Se obtienen los exploradores del JSON que tienen la mision node
const usernamesInNode = explorersInNodeToGetUsernames.map((explorer) => explorer.githubUsername);//Se obtienen los usernames de los exploradores obtenidos anteriormente
